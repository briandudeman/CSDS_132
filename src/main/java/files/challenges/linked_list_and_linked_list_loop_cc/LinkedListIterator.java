package files.challenges.linked_list_and_linked_list_loop_cc;

import java.util.Iterator;
import java.util.NoSuchElementException;

import files.challenges.linked_list_node_cc.LLNode;

/** An iterator for our linked list. The iterator loops over the data in the list
from
...
public class LinkedListIterator<T> implements Iterator<T> {
    ...
    /**
    * Create an iterator that loops over the data in the list starting at the given
    first node
